...
namespace Cyan.CT.Editor
{
    public class CyanTriggerSerializedProgramManager : UnityEditor.AssetModificationProcessor
    {
        ...
        */
        ...
        {
            return $"{SerializedUdonAssetNamePrefix}{guid}";
        }
        ...
        {
            string assetPath = Path.Combine(GetSerializedUdonDirectoryPath(), $"{GetExpectedProgramName(guid)}.asset");
        ...
        public void ApplyTriggerPrograms(List<CyanTrigger> triggers, bool force = false)
        {
            ...
            try
            {
                // Unity 2022 will complain about changes during inport and error on the first asset creation.
                // "Global asset import parameters have been changed during import. Importing is restarted."
                // Adding AssetDatabase.Refresh() seems to prevent issue, meaning it is happening outside this method?
