        ...
        */
        ...
        public static void ConvertBlankCustomEvents(CyanTriggerAssemblyProgram program, bool isInstance)
        {
            ...
            string sendCustomEventName = CyanTriggerDefinitionResolver.GetMethodSignature(
                typeof(IUdonEventReceiver).GetMethod(nameof(IUdonEventReceiver.SendCustomEvent), 0, flags, null, CallingConventions.Any, new []{typeof(string)}, null));
            string sendCustomNetworkedEventName = CyanTriggerDefinitionResolver.GetMethodSignature(
                typeof(IUdonEventReceiver).GetMethod(nameof(IUdonEventReceiver.SendCustomNetworkEvent), 0, flags, null, CallingConventions.Any, new []{typeof(NetworkEventTarget), typeof(string)}, null));
            string sendCustomEventDelayedSecondsName = CyanTriggerDefinitionResolver.GetMethodSignature(
                typeof(IUdonEventReceiver).GetMethod(nameof(IUdonEventReceiver.SendCustomEventDelayedSeconds), 0, flags, null, CallingConventions.Any, new []{typeof(string), typeof(float), typeof(EventTiming)}, null));
            string sendCustomEventDelayedFramesName = CyanTriggerDefinitionResolver.GetMethodSignature(
                typeof(IUdonEventReceiver).GetMethod(nameof(IUdonEventReceiver.SendCustomEventDelayedFrames), 0, flags, null, CallingConventions.Any, new []{typeof(string), typeof(int), typeof(EventTiming)}, null));
#else
            string sendCustomEventName = CyanTriggerDefinitionResolver.GetMethodSignature(
                typeof(IUdonEventReceiver).GetMethod(nameof(IUdonEventReceiver.SendCustomEvent), new []{typeof(string)}));
            string sendCustomNetworkedEventName = CyanTriggerDefinitionResolver.GetMethodSignature(
                typeof(IUdonEventReceiver).GetMethod(nameof(IUdonEventReceiver.SendCustomNetworkEvent), new []{typeof(NetworkEventTarget), typeof(string)}));
            string sendCustomEventDelayedSecondsName = CyanTriggerDefinitionResolver.GetMethodSignature(
                typeof(IUdonEventReceiver).GetMethod(nameof(IUdonEventReceiver.SendCustomEventDelayedSeconds), new []{typeof(string), typeof(float), typeof(EventTiming)}));
            string sendCustomEventDelayedFramesName = CyanTriggerDefinitionResolver.GetMethodSignature(
                typeof(IUdonEventReceiver).GetMethod(nameof(IUdonEventReceiver.SendCustomEventDelayedFrames), new []{typeof(string), typeof(int), typeof(EventTiming)}));
#endif
