...
namespace Cyan.CT.Editor
{
    ...
    public class CyanTriggerAssemblyData
    {
        ...
        public CyanTriggerAssemblyDataType CreateReferenceVariable(Type type)
        {
            ...
            // Constants will not be public serialized, and thus should not be exported.
            bool shouldExport = !CyanTriggerUtil.IsTypeConstant(type);

            return AddVariable("ref", type, shouldExport);
        }
