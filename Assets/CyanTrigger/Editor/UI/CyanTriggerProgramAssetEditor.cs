...
namespace Cyan.CT.Editor
{
    ...
    public class CyanTriggerProgramAssetBaseEditor : ICyanTriggerBaseEditor
    {
        ...
        private static readonly List<CyanTriggerProgramAssetBaseEditor> OpenEditors =
            new List<CyanTriggerProgramAssetBaseEditor>();
        ...
        public static void CheckOpenEditorsForNeedsRecompile()
        {
            foreach (var openEditor in OpenEditors)
            {
                openEditor.CheckNeedsRecompile();
            }
        }
        ...
        private void DisplayUtilityActions()
        {
            ...
            {
                var customAction = CyanTriggerActionGroupDefinitionUdonAsset.CreateCustomActionForProgramAsset(_cyanTriggerEditableProgramAsset);
