...
namespace Cyan.CT.Editor
{
    public class CyanTriggerSearchWindowManager
    {
        ...
        public void DisplayVariableSearchWindow(
            Action<UdonNodeDefinition> onSelect, 
            bool allowNull = false, 
            bool allowRightClickAdd = true)
        {
            DisplayVariableSearchWindow(GetMousePos(), onSelect, allowNull, allowRightClickAdd);
        }
            ...
            bool allowRightClickAdd = true)
        {
            ...
            _variableSearchWindow.allowNull = allowNull;
            _variableSearchWindow.allowRightClickAdd = allowRightClickAdd;
            ...
            Action<CyanTriggerActionGroupDefinition> onSelectCustom)
        {
            ...
            _variableSearchWindow.allowNull = false;
            _variableSearchWindow.allowRightClickAdd = true;
            CyanTriggerSearchWindow.Open(new SearchWindowContext(pos, WindowWidth), _variableSearchWindow);
        }
