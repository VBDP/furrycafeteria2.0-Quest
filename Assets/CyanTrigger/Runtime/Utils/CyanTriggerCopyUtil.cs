...
namespace Cyan.CT
{
    public static class CyanTriggerCopyUtil
    {
        ...
        private static void CopyData(
            bool copyData,
            CyanTriggerSerializableObject original,
            ref CyanTriggerSerializableObject output) {
            
            object data = original.Obj;
            if (copyData || (data != null && !(data is UnityEngine.Object)))
            {
                ...
                output = new CyanTriggerSerializableObject(data);
            }
        }
        ...
        public static CyanTriggerVariable CopyVariable(CyanTriggerVariable variable, bool copyData)
        {
            ...
            CopyData(copyData, variable.data, ref ret.data);
