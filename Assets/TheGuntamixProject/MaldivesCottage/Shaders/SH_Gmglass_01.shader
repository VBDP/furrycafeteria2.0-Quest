Shader "SH_Gmglass_01"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 tex2DNode5 = UnpackScaleNormal( tex2D( _NormalMap, uv_NormalMap ), _NormalScale );
			o.Normal = tex2DNode5;
			o.Albedo = ( _Color0 * ( texCUBE( _CubeMap, WorldReflectionVector( i , tex2DNode5 ) ) * 5 ) ).rgb;
			o.Alpha = _Opacity;
